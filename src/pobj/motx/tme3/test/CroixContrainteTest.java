...
public class CroixContrainteTest {
	...
	public void test3() {
		...
		CroixContrainte c1 = new CroixContrainte(0,2,2,0);
		System.out.println("nbReduce: " + c1.reduce(gp));

		CroixContrainte c2 = new CroixContrainte(1,2,2,4);
		System.out.println("nbReduce: " + c2.reduce(gp));
	}
